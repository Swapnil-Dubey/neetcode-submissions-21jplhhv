class Solution:
    def findOrder(self, numCourses: int, prerequisites: List[List[int]]) -> List[int]:
        ...
        #pattern: Graphs
        #approach: make course:[prereq] map, run dfs on every course and within the dfs run recursive dfs on every prereq
        #edge cases: no prereq course, cycle prereq (return [] or false)
        #time complexity:
        #space complexity: 
