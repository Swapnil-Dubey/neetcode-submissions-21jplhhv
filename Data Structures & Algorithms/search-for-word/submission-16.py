    ...
    def exist(self, board: List[List[str]], word: str) -> bool:
        ...
        def dfs(n,r,c):
            ...
            if word[n]==board[r][c]:
                ...
                visited.remove((r,c))
                if n == len(word)-1: #### imppp* early return in this case, if there 
                #is a single cahracter, no other branches to explore and iff the word 
                #is found then res remains false even though the word is done in current 
                #iteration
                    return True
                return res
            else:
