    ...
    def evalRPN(self, tokens: List[str]) -> int:
        ...
        for s in tokens:
            if s == "+":
                ...
                stack.append(int(s)) # imp have to separate this and cant put latest, second popping outisde each because if theres just 1 number in the stack then it causes problems
        return stack[0]
